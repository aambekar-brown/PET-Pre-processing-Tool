...
- **A Shiny R Appplication**: A tool for automated neuroimaging preprocessing with interactive visualization, artifact inspection and error handling capabilities for smooth execution, with clear and informative messages displayed in the output console for user guidance.
...
- **MNI Template Registration**: Align MRI scans to the MNI standard space for consistent spatial analysis.
  ![MNI Template Registeration Example](assets/images/MRI_Template_Registeration.png)
- **MRI-PET Co-registration**: Aligns PET scans with corresponding MRI scans for integrated analysis.
  ![MRI-PET Co-Registeration Example](assets/images/MRI-PET_CoRegisteration.png)
